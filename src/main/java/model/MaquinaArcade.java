...
public class MaquinaArcade {
    ...
    public void actualizarRanking(int nuevaPuntuacion, Jugador jugadorActualizarRanking) {
        ...
        if (nuevaPuntuacion > this.mejoresPuntuaciones[0]) {
            ...
            this.mejoresPuntuaciones[2] = this.mejoresPuntuaciones[1];
            this.mejoresJugadores[2] = this.mejoresJugadores[1];
            //Mover Top 1 al Top 2
            this.mejoresPuntuaciones[1] = this.mejoresPuntuaciones[0];
            this.mejoresJugadores[1] = this.mejoresJugadores[0];
            //Poner el Top 1
